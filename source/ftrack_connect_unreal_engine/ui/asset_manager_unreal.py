...
from ftrack_connect.ui.widget.asset_manager import FtrackAssetManagerDialog, AssetManagerWidget
    ...
    def getSceneSelection(self):
        ...
        for asset, assetSceneName in selectedAssets:
            ...
            for item in foundItems:
                ...
                nameItem = self.ui.AssertManagerTableWidget.itemFromIndex(index.sibling(index.row(),8))
